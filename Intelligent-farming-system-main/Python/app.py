...
def fetchingApi(inputVal):
    heavy_rains_id = [201, 202, 211, 212, 232, 314, 501, 502, 503, 504, 511, 522]
    response_API = requests.get(f'https://api.openweathermap.org/data/2.5/weather?q={inputVal}&APPID={apiKey}')

    if response_API.status_code != 200:
        return True  # Return true to not block irrigation if API fails
